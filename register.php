...
<head>
    ...
    <title>ZeusWatch - Register</title>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" style="border-color: red" id="username"
                                        placeholder="Username">
                                    <p style="display: none;">&check;</p>
                                    <p style="color: red; display:inherit; position: absolute; top:41%; left: 73%; font-size: small">Username Taken &CircleTimes;</p>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="/ZeusWatch/">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
