...
function weekly(mon, tues, wed, thurs, fri)  {
  $.ajax({
    ...
    success: function(day) {
      ...
      myBarChart.data.datasets[0].data[0] = day.mon
      myBarChart.data.datasets[0].data[1] = day.tues
      myBarChart.data.datasets[0].data[2] = day.wed
      myBarChart.data.datasets[0].data[3] = day.thurs
      myBarChart.data.datasets[0].data[4] = day.fri
      myBarChart.options.scales.yAxes.pop()
      myBarChart.options.scales.yAxes.push({
        ticks: {
          min: 0,
