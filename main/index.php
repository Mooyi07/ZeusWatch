...
<head>
    ...
    <title>ZeusWatch - Dashboard</title>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Daily Consumption</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="dailyCons"></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Weekly Consumption</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="weeklyCons"></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Weekly Overview</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Predicted Weekly Value</h6> 
                                    <button id="predicting" onclick="typeWriter(); predict()" style="background-color: #4e73df; border-color:blue; border-radius: 10px; color: white; font-weight: bold">Generate</button>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-bar">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body" style="height: 23em">
                                    <p id="suggestions" style="white-space: pre-wrap; color: black"></p>
                                </div>
                            </div>
                        </div>
                    </div>
