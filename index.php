...
<head>
    ...
    <title>ZeusWatch - Login</title>
    <link rel="icon" href="main/img/logo.png"> 
            ...
            <div class="col-xl-11 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="display: flex; text-align: center; padding-top: 8vh">
                                <img style="height: 40vh; " src="main/img/logo.png" alt="logo">
                                <h1 style="color: black; padding-top: 2vh; padding-bottom: 5vh">ZeusWatch</h1>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php if (isset($_GET["wrong"])){
                                        ?><h1 style="color:red; text-align: center; font-size: 20px;" id="wrong">Wrong Username or Password</h1><?php
                                    }
                                    ?>
                                    <form class="user" action="loginProccess.php" method="POST">
